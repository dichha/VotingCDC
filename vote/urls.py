...
from vote.views import (landing_view, login_view, register_view, logout_view, post_candidates, candidates_detail, staff_view, user_view, candidates, candidates_update, candidate_deleted,candidate_delete_confirmation,user_info,user_info_update,post_election,election_detail, elections, election_update)
